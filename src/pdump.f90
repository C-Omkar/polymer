...
! DUMP THE ELEMENTS OF A REAL MATRIX OF THE FORM W(N,N,-UX:UX,-UY:UY,-UZ:UZ)
   ...
   DO JZ=0,UZ
    ...
    DO K=1,I
     WRITE(IFILE,'(3X,10I20)') (L,L=10*K-9,10*K)
     DO L=1,N
      WRITE(IFILE,'(I5,10F20.14)') L,(W(L,M,JX,JY,JZ),M=10*K-9,10*K)
     ENDDO
    ENDDO
    IF (N /= I*10) THEN
     WRITE(IFILE,'(3X,10I20)') (L,L=10*I+1,N)
     DO L=1,N
      WRITE(IFILE,'(I5,10F20.14:)') L,(W(L,M,JX,JY,JZ),M=10*I+1,N)
     ENDDO
    ENDIF
   ENDDO
   ENDDO
