...
! MOLECULAR INTEGRALS
   ...
   DOUBLE COMPLEX,ALLOCATABLE :: FTDS(:,:,:,:,:)                        ! FINITE TEMPERATURE FOCK DIFFERENCE MATRIX FOR SOLIDS
   DOUBLE PRECISION,ALLOCATABLE :: FTDM(:,:)                              ! FINITE TEMPERATURE FOCK MATRIX FOR MOLECULES
END MODULE
