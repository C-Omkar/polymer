...
! -- HELIX
   ...
   WRITE(6,'(A,F20.6,A)') 'BETA      = ',BETA,' HARTREE**-1'
...
! NBAR Calculation
   ...
   DO MOI=ICORE+1,IALL(0,0,0)-IVIRTCORE
      ...
      NBAR=NBAR+2.0D0*FI
   ENDDO
   WRITE(6,'(A,F20.6,A)') 'NUMBER OF ELECTRONS = ',NBAR,' ELECTRONS'
...
!    ENDDO
   ...
   WRITE(6,'(A,F20.15,A)') 'MP1_MU    = ',MP1_MU,' HARTREE'
   WRITE(6,'(A,F20.15,A)') 'MP1_OMEGA = ',MP1_OMEGA,' HARTREE'
   WRITE(6,'(A,F20.15,A)') 'MP1_U     = ',MP1_U,' HARTREE'
   WRITE(6,'(A,F20.15,A)') 'MP2_MU    = ',MP2_MU,' HARTREE'
   WRITE(6,'(A,F20.15,A)') 'MP2_OMEGA = ',MP2_OMEGA,' HARTREE'
   WRITE(6,'(A,F20.15,A)') 'MP2_U     = ',MP2_U,' HARTREE'
...
!  ENDIF
   ...
   WRITE(6, '(F20.6,A)') DOPTN(98), ' MP TEMPERATURE (K)'
   WRITE(6, '(F20.10,A)') BETA, ' BETA (HARTREE**-1)'
   WRITE(6, '(F20.10,A)') MU, ' FERMI ENERGY (HARTREE)'
   ...
   WRITE(6,'(A,F20.6,A)') 'AVERAGE NUMBER OF ELECTRONS PER UNIT CELL = ',NBAR,' ELECTRONS'
   ...
   WRITE(6,'(A,F40.20,A)') 'NORMDIRAC BEFORE NORMALIZATION = ',NORMDIRAC,' '
...
SUBROUTINE FINITE_MP2_ENERGY_SOLIDS
! TRANSFORM TWO-ELECTRON INTEGRALS BY O(N**5) ALGORITHM AND EVALUATE MP2 CORRECTION.
! AO-BASED TWO-ELECTRON INTEGRALS ARE RETRIEVED FROM DISK.
...
!  INTEGER :: KJOBS,KJOBE
   ...
   DOUBLE PRECISION :: EI,EJ,EA,EB,D,FI,FJ,FA,FB
   DOUBLE PRECISION :: ERRORTRAP
   ! DOUBLE COMPLEX, ALLOCATABLE ::  FTDS(:,:,:,:,:)
!  INTEGER,ALLOCATABLE :: KVC3(:)
!  LOGICAL,ALLOCATABLE :: LKVC(:,:)
   INTEGER :: TICKET
   INTEGER :: NFILES,IFILE,JFILE
