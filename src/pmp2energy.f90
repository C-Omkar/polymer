...
!  INTEGER :: KJOBS,KJOBE
   ...
   DOUBLE PRECISION :: MP0_OMEGA,MP0_U,MP0_MU
...
! -- HELIX
   ...
   IF(KVCX==0 .AND. KVCY==0 .AND. KVCZ==0) THEN
...
!write(*,*) 'Process:',myid,' reading from ',TRIM(COPTN(1))//'.ao.'//FILEAPPENDIX(2:6)
     ...
     DO MOJ=ICORE+1,IALL(KJX,KJY,KJZ)-IVIRTCORE
       ...
       TEMPORARY=4.0D0*TOVOKK(MOJ,MOJ,MOB,LINIDXJ,LINIDXB)-2.0D0*DCONJG(TOVOKK(MOB,MOJ,MOJ,LINIDXJ,LINIDXJ))
...
!write(*,*) emp2s_tmp,emp2t_tmp
   ...
   !  ENDIF
    ...
    WRITE(6,'(A,F20.15,A)') 'MP1 OMEGA = ',MP1_OMEGA,' HARTREE'
    WRITE(6,'(A,F20.15,A)') 'MP1 U     = ',MP1_U,' HARTREE'
    WRITE(*,*) 'MP2 MU    = ',MP2_MU,' HARTREE'
    WRITE(*,*) 'MP2 OMEGA = ',MP2_OMEGA,' HARTREE'
    WRITE(*,*) 'MP2 U     = ',MP2_U,' HARTREE'
