...
!  ENDIF
   ...
   DO MOI=ICORE+1,IALL(KIX,KIY,KIZ)-IVIRTCORE
    EB=EPSILON(MOI,KIX*NMOD,KIY*NMOD,KIZ*NMOD)
    FB=1.0D0/(EXP((EB-MU)*BETA)+1.0D0)
    TEMPORARY=1.0D0*DREAL(FTDS(MOI,MOI,KIX*NMOD,KIY*NMOD,KIZ*NMOD))*FB
    MP1_OMEGA_1E_TMP=MP1_OMEGA_1E_TMP+2.0D0*TEMPORARY
    MP1_U_1E_TMP=MP1_U_1E_TMP+2.0D0*TEMPORARY
    MP1_MU=MP1_MU+2.0D0*TEMPORARY*(1.0D0-FB)
